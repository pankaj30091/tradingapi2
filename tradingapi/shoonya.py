...
class Shoonya(BrokerBase):
    ...
    def get_margin_requirement(self, combo_symbol: str, order_size: int, exchange: str = "NSE", mds=None, net: bool = False) -> float:
        """Return margin requirement via Shoonya span_calculator API."""
        if self.api is None:
            raise BrokerConnectionError("Shoonya API not connected")
