...
This module is runnable as a script (e.g. via the icicidirect-generate-session
entry point or python -m tradingapi.icicidirect_generate_session). It automates
the login redirect flow and prints only the generated session token to stdout
for use with ICICIDIRECT.AUTO_SESSION_TOKEN_CMD.
